  ...
  return (
    ...
    <section className="departments px-5 pt-5 pb-10  grid grid-cols-1 lg:grid-cols-3 md:grid-cols-2 2xl:grid-cols-4">
      {departments.map((eachDept)=>{
        ...
        return (
          <div key={id} className="flex flex-col items-center px-2 py-5 justify-center border border-violet-900 rounded-lg md:mx-5 my-3 mx-auto hover:bg-violet-100 transition-all w-[98%] md:w-auto">
