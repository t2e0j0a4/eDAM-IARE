      ...
      <footer className="w-[100%] bg-violet-300 py-1">
        ...
        <div className="w-[100%] middlerow grid grid-cols-1 grid-rows-4 md:grid-cols-2 md:grid-rows-2 lg:grid-cols-4 lg:grid-rows-1 py-2">
          ...
          <div className="flex flex-col items-center justify-center py-1">
            ...
            <Link className="my-1 text-lg hover:underline hover:text-violet-800 hover:bg-white hover:rounded-md hover:px-2 break-words" to="/about">About Us</Link>
            <Link className="my-1 text-lg hover:underline hover:text-violet-800 hover:bg-white hover:rounded-md hover:px-2 break-words" to="/departments">Depatments</Link>
            <Link className="my-1 text-lg hover:underline hover:text-violet-800 hover:bg-white hover:rounded-md hover:px-2 break-words" to="/joinus">Join Us</Link>
          </div>
